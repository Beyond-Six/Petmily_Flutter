...
class _CommunityPageState extends State<CommunityPage> {
  ...
  final _dropdown_items_pet = ['All','Dogs','Cats','Birds','Rapts'];
  ...
  var tags = ["PetAdopt","Vets","Train","Walk","Food","Help"];
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      child: Column(
                        children: <Widget>[
                          FakePost(pet_post_list : Dog_Post_Fake_Info,tag_clicked : tagButtonSelected),
                          FakePost(pet_post_list : Cat_Post_Fake_Info,tag_clicked : tagButtonSelected),
                          FakePost(pet_post_list : Bird_Post_Fake_Info,tag_clicked : tagButtonSelected),
                          FakePost(pet_post_list : Rept_Post_Fake_Info,tag_clicked : tagButtonSelected),
                        ],
                      ),
                    ),
                  ],
  ...
  void Set_Fake_Post_info(){
    ...
    Dog_Post_Fake_Info.pet_tag_info = [false, true, false, false, true, false];
    ...
    Cat_Post_Fake_Info.pet_tag_info = [true, false, false, false, true, true];
    ...
    Bird_Post_Fake_Info.pet_tag_info = [false, true, false, false, true, true];
    ...
    Rept_Post_Fake_Info.pet_tag_info = [false, true, true, false, true, false];
  }
}
